...
class WaveClipperOne extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    Offset firstEndPoint = Offset(size.width * .3, size.height - 100);
    Offset firstControlPoint = Offset(size.width * .20, size.height - 100);
    Offset secondEndPoint = Offset(size.width, size.height - 180);
    Offset secondControlPoint = Offset(size.width * .50, size.height - 90);
...
class WaveClipperTwo extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    Offset secondControlPoint = Offset(size.width * .0, size.height - 10);
