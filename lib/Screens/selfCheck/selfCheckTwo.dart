...
class SelfCheckPageTwo extends StatelessWidget {
  const SelfCheckPageTwo({Key? key}) : super(key: key);
        ...
        body: SafeArea(
            child: SingleChildScrollView(
                child: SelfCheckWidget(
                    usedGif: Image.asset('assets/y4.gif'),
                    ...
                    buttonUsed: CustomButton(
                      buttonTitle: 'Next',
                      navigationFunction: () {
                        Navigator.pushNamed(context, '/selfCheckPageThree');
                      },
                    )))));
  }
}
